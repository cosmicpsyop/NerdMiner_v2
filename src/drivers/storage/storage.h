...
#define DEFAULT_STARTUP_SCREEN	0
...
#define JSON_KEY_STARTUPSCREEN	"StartupScreen"
...
#define JSON_SPIFFS_KEY_STARTUPSCREEN	"startupScreen"
...
struct TSettings
{
	...
	int StartupScreen{ DEFAULT_STARTUP_SCREEN };
};
